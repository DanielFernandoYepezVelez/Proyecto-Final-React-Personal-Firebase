    ...
    let individualProduct = [
        {
            ...
            information: {
                ...
                available: "si",
                quantity: 10,
                description: "Camiseta Original De La Banda Description",
            }
        },
        {
            mainBoxArea: "box__container--areaMain",
            ...
            information: {
                ...
                available: "si",
                quantity: 30,
                description: "Video Concierto One Direction Tour Description",
            }
        },
        {
            mainBoxArea: "box__container--areaMain",
            ...
            information: {
                ...
                available: "si",
                quantity: 40,
                description: "Cartuchera Estudiantil Description",
            }
        },
        {
            ...
            information: {
                name: "Perfume Sauvage One Direction",
                ...
                available: "si",
                quantity: 40,
                description: "Perfume Sauvage One Direction Description",
            }
        },
        {
            mainBoxArea: "box__container--imagePosition1",
            ...
            information: {
                ...
                available: "si",
                quantity: 50,
                description: "Chompa Negra XL Description",
            }
        },
        {
            mainBoxArea: "box__container--imagePosition1",
            ...
            information: {
                ...
                available: "si",
                quantity: 60,
                description: "Vinilo De La Banda One Direction Description",
            }
        }
    ];
